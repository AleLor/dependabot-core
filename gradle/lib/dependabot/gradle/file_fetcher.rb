...
module Dependabot
  module Gradle
    class FileFetcher < Dependabot::FileFetchers::Base
      ...
      SUPPORTED_WRAPPER_FILE_NAME =
        %w(gradle-wrapper.properties).freeze
      ...
      def all_buildfiles_in_build(root_dir)
        files = [buildfile(root_dir), settings_file(root_dir), wrapper_file(root_dir)].compact
      ...
      def wrapper_file(dir)
        find_first(dir, SUPPORTED_WRAPPER_FILE_NAME)
      end
